                ...
                {cart.length > 0 && (
                  <div className="space-y-8 bg-brand-cream/60 p-10 rounded-[4rem] border-4 border-brand-accent shadow-inner relative overflow-hidden">
                    ...
                    <h3 className="text-[10px] font-black uppercase text-brand-primary tracking-[0.5em] flex items-center gap-3 mb-4">
                      <Search size={18} /> IDENTIFICACAO E ENTREGA
                    </h3>
                    ...
                    <div className="space-y-6">
                      ...
                      <div className="grid grid-cols-4 gap-4">
                         <input type="text" placeholder="Endereco / Rua" value={customerDetails.address} onChange={(e) => setCustomerDetails({...customerDetails, address: e.target.value})} className="col-span-3 px-8 py-5 rounded-[2rem] border-2 border-brand-accent text-sm font-black shadow-sm" />
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <input type="text" placeholder="Ponto de Referencia" value={customerDetails.reference} onChange={(e) => setCustomerDetails({...customerDetails, reference: e.target.value})} className="w-full px-8 py-5 rounded-[2rem] border-2 border-brand-accent text-sm font-black shadow-sm" />
                      </div>
      ...
      <footer className="bg-brand-dark text-stone-500 py-32 mt-40 border-t-[12px] border-brand-primary px-4">
        ...
        <div className="max-w-7xl mx-auto pt-20 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-10 text-[11px] font-black uppercase tracking-[0.3em] opacity-30">
          ...
          <div className="flex gap-12 items-center">
            ...
            <Link to="/admin" className="w-10 h-10 flex items-center justify-center rounded-2xl hover:bg-white/10 transition-all text-white group">
